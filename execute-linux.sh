...
./outputs/linux/pdf-extractor get chapters --file="Journal Jan-Jun 2022.pdf" --output-path="./configs"
# ./outputs/linux/pdf-extractor extract --file="Vol. 14. N. 2, 2022.pdf" --output-path="./chapters" --config-path="./configs"
